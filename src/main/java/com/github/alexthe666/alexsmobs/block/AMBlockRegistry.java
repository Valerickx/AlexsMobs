...
public class AMBlockRegistry {
    ...
    public static final DeferredRegister<Block> DEF_REG = DeferredRegister.create(BuiltInRegistries.BLOCK, AlexsMobs.MODID);
    ...
    public static final DeferredHolder<Block, Block> SAND_CIRCLE = registerBlockAndItem("sand_circle", () -> new SandBlock(new net.minecraft.util.ColorRGBA(14406560), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND)), new Item.Properties(), false);
    public static final DeferredHolder<Block, Block> RED_SAND_CIRCLE = registerBlockAndItem("red_sand_circle", () -> new SandBlock(new net.minecraft.util.ColorRGBA(11098145), BlockBehaviour.Properties.ofFullCopy(Blocks.RED_SAND)), new Item.Properties(), false);
