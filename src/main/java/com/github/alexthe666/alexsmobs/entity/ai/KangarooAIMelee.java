...
public class KangarooAIMelee extends MeleeAttackGoal {
    ...
    protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
        double d0 = (double)(this.kangaroo.getBbWidth() * 2.0F * this.kangaroo.getBbWidth() * 2.0F + enemy.getBbWidth()) + 5D;
        if (distToEnemySqr <= d0) {
            if(kangaroo.isInWater()){
                ...
                enemy.knockback(1F, enemy.getX() - kangaroo.getX(), enemy.getZ() - kangaroo.getZ(), null, 0.0F);
