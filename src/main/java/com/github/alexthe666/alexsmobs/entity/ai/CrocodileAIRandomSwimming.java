...
public class CrocodileAIRandomSwimming extends RandomStrollGoal {
    ...
    protected Vec3 getPosition() {
        ...
        for(int i = 0; vector3d != null && !this.mob.level().getBlockState(AMBlockPos.fromVec3(vector3d)).isPathfindable(PathComputationType.WATER) && i++ < 15; vector3d = DefaultRandomPos.getPos(this.mob, 10, 7)) {
        }
