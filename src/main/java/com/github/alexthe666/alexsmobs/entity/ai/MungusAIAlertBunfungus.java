    ...
    protected void alertOthers() {
        ...
        while(true) {
            ...
            while(true) {
                ...
                mob = (EntityBunfungus)iterator.next();
                if (this.mob != mob && mob.getTarget() == null && !mob.isAlliedTo(this.mob.getLastHurtByMob()) && mob.defendsMungusAgainst(this.mob.getLastHurtByMob())) {
