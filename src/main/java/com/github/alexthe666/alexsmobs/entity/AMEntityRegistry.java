...
public class AMEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityCockroachEgg>> COCKROACH_EGG = DEF_REG.register("cockroach_egg", () -> registerEntity(EntityType.Builder.of((EntityType<EntityCockroachEgg> type, Level level) -> new EntityCockroachEgg(type, level), MobCategory.MISC).sized(0.5F, 0.5F).fireImmune(), "cockroach_egg"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntitySnowLeopard>> SNOW_LEOPARD = DEF_REG.register("snow_leopard", () -> registerEntity(EntityType.Builder.of(EntitySnowLeopard::new, MobCategory.CREATURE).sized(1.2F, 1.3F).immuneTo(BlockTags.SNOW).setTrackingRange(10), "snow_leopard"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityEmuEgg>> EMU_EGG = DEF_REG.register("emu_egg", () -> registerEntity(EntityType.Builder.of((EntityType<EntityEmuEgg> type, Level level) -> new EntityEmuEgg(type, level), MobCategory.MISC).sized(0.5F, 0.5F).fireImmune(), "emu_egg"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityEnderiophageRocket>> ENDERIOPHAGE_ROCKET = DEF_REG.register("enderiophage_rocket", () -> registerEntity(EntityType.Builder.of((EntityType<EntityEnderiophageRocket> type, Level level) -> new EntityEnderiophageRocket(type, level), MobCategory.MISC).sized(0.5F, 0.5F).fireImmune(), "enderiophage_rocket"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityFroststalker>> FROSTSTALKER = DEF_REG.register("froststalker", () -> registerEntity(EntityType.Builder.of(EntityFroststalker::new, MobCategory.CREATURE).sized(0.95F, 1.15F).immuneTo(BlockTags.SNOW), "froststalker"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityTusklin>> TUSKLIN = DEF_REG.register("tusklin", () -> registerEntity(EntityType.Builder.of(EntityTusklin::new, MobCategory.CREATURE).sized(2.2F, 1.9F).immuneTo(BlockTags.SNOW).setTrackingRange(10), "tusklin"));
    ...
    private static EntityType registerEntity(EntityType.Builder builder, String entityName) {
        return builder.build(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ENTITY_TYPE, net.minecraft.resources.Identifier.fromNamespaceAndPath("alexsmobs", entityName)));
    }
    ...
    public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
        ...
        event.register(GRIZZLY_BEAR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ROADRUNNER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityRoadrunner.canRoadrunnerSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BONE_SERPENT.get(), SpawnPlacementTypes.IN_LAVA, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityBoneSerpent.canBoneSerpentSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(GAZELLE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CROCODILE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCrocodile.canCrocodileSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FLY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityFly.canFlySpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(HUMMINGBIRD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityHummingbird.canHummingbirdSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ORCA.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityOrca.canOrcaSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SUNBIRD.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySunbird.canSunbirdSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(GORILLA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityGorilla.canGorillaSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CRIMSON_MOSQUITO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCrimsonMosquito.canMosquitoSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(RATTLESNAKE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityRattlesnake.canRattlesnakeSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ENDERGRADE.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityEndergrade.canEndergradeSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(HAMMERHEAD_SHARK.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityHammerheadShark.canHammerheadSharkSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(LOBSTER.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityLobster.canLobsterSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(KOMODO_DRAGON.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityKomodoDragon.canKomodoDragonSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CAPUCHIN_MONKEY.get(), spawnsOnLeaves, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityCapuchinMonkey.canCapuchinSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CENTIPEDE_HEAD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCentipedeHead.canCentipedeSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(WARPED_TOAD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityWarpedToad.canWarpedToadSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MOOSE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMoose.canMooseSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MIMICUBE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Mob.checkMobSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(RACCOON.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BLOBFISH.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityBlobfish.canBlobfishSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SEAL.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySeal.canSealSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(COCKROACH.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCockroach.canCockroachSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SHOEBILL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ELEPHANT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SOUL_VULTURE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySoulVulture.canVultureSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SNOW_LEOPARD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySnowLeopard.canSnowLeopardSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CROW.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityCrow.canCrowSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ALLIGATOR_SNAPPING_TURTLE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityAlligatorSnappingTurtle.canTurtleSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MUNGUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMungus.canMungusSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MANTIS_SHRIMP.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMantisShrimp.canMantisShrimpSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(GUSTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityGuster.canGusterSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(WARPED_MOSCO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Monster.checkAnyLightMonsterSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(STRADDLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityStraddler.canStraddlerSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(STRADPOLE.get(), SpawnPlacementTypes.IN_LAVA, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityStradpole.canStradpoleSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(EMU.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityEmu.canEmuSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(PLATYPUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityPlatypus.canPlatypusSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(DROPBEAR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Monster.checkAnyLightMonsterSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TASMANIAN_DEVIL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(KANGAROO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityKangaroo.canKangarooSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CACHALOT_WHALE.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCachalotWhale.canCachalotWhaleSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(LEAFCUTTER_ANT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> Animal.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ENDERIOPHAGE.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityEnderiophage.canEnderiophageSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BALD_EAGLE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityBaldEagle.canEagleSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TIGER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityTiger.canTigerSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TARANTULA_HAWK.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityTarantulaHawk.canTarantulaHawkSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(VOID_WORM.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityVoidWorm.canVoidWormSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FRILLED_SHARK.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityFrilledShark.canFrilledSharkSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MIMIC_OCTOPUS.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMimicOctopus.canMimicOctopusSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SEAGULL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySeagull.canSeagullSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FROSTSTALKER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityFroststalker.canFroststalkerSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TUSKLIN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityTusklin.canTusklinSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(LAVIATHAN.get(), SpawnPlacementTypes.IN_LAVA, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityLaviathan.canLaviathanSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(COSMAW.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCosmaw.canCosmawSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TOUCAN.get(), spawnsOnLeaves, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityToucan.canToucanSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MANED_WOLF.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityManedWolf.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ANACONDA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityAnaconda.canAnacondaSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ANTEATER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityAnteater.canAnteaterSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(ROCKY_ROLLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityRockyRoller.checkRockyRollerSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FLUTTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityFlutter.canFlutterSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(GELADA_MONKEY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityGeladaMonkey.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(JERBOA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityJerboa.canJerboaSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TERRAPIN.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityTerrapin.canTerrapinSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(COMB_JELLY.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCombJelly.canCombJellySpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BUNFUNGUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityBunfungus.canBunfungusSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BISON.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityBison.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(GIANT_SQUID.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityGiantSquid.canGiantSquidSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(DEVILS_HOLE_PUPFISH.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityDevilsHolePupfish.canPupfishSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CATFISH.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCatfish.canCatfishSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FLYING_FISH.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> WaterAnimal.checkSurfaceWaterAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SKELEWAG.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySkelewag.canSkelewagSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(RAIN_FROG.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityRainFrog.canRainFrogSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(POTOO.get(), spawnsOnLeaves, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityPotoo.canPotooSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MUDSKIPPER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMudskipper.canMudskipperSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(RHINOCEROS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityRhinoceros.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SUGAR_GLIDER.get(), spawnsOnLeaves, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntitySugarGlider.canSugarGliderSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(FARSEER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityFarseer.checkFarseerSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SKREECHER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySkreecher.checkSkreecherSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(UNDERMINER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityUnderminer.checkUnderminerSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(MURMUR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityMurmur.checkMurmurSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(SKUNK.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntitySkunk.checkAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BANANA_SLUG.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityBananaSlug.checkBananaSlugSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(BLUE_JAY.get(), spawnsOnLeaves, Heightmap.Types.MOTION_BLOCKING, (type, level, reason, pos, random) -> EntityBlueJay.checkBlueJaySpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(CAIMAN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> EntityCaiman.canCaimanSpawn(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
        event.register(TRIOPS.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (type, level, reason, pos, random) -> WaterAnimal.checkSurfaceWaterAnimalSpawnRules(type, level, reason, pos, random), RegisterSpawnPlacementsEvent.Operation.REPLACE);
    ...
    public static Predicate<LivingEntity> buildPredicateFromTagTameable(TagKey<EntityType<?>> entityTag, LivingEntity owner){
        if(entityTag == null){
            ...
            return e -> e.isAlive() && e.getType().builtInRegistryHolder().is(entityTag) && !owner.isAlliedTo(e);
        }
    }
