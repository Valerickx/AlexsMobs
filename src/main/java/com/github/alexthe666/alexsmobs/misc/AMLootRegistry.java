...
public class AMLootRegistry {
    ...
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<BananaLootModifier>> BANANA_DROP = DEF_REG.register("banana_drop", BananaLootModifier.CODEC);
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<BlossomLootModifier>> BLOSSOM_DROP = DEF_REG.register("blossom_drop", BlossomLootModifier.CODEC);
