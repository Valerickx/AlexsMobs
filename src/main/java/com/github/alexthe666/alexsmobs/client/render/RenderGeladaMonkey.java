...
public class RenderGeladaMonkey extends MobRenderer<EntityGeladaMonkey, LivingEntityRenderState, ModelGeladaMonkey> {
    ...
    public Identifier getTextureLocation(EntityGeladaMonkey entity) {
