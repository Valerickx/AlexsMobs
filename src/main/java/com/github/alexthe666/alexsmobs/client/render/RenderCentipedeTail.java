...
public class RenderCentipedeTail extends MobRenderer<EntityCentipedeTail, LivingEntityRenderState, AdvancedEntityModel<EntityCentipedeTail>> {
    ...
    public Identifier getTextureLocation(EntityCentipedeTail entity) {
        return TEXTURE;
    }
}
