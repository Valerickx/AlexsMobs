...
public class ModelHammerheadShark extends AdvancedEntityModel<EntityHammerheadShark> {
	...
	public ModelHammerheadShark() {
		...
		main_body = new AdvancedModelBox(this, "main_body");
		...
		head_hammer = new AdvancedModelBox(this, "head_hammer");
		...
		finL = new AdvancedModelBox(this, "finL");
		...
		finR = new AdvancedModelBox(this, "finR");
		...
		topfin = new AdvancedModelBox(this, "topfin");
		...
		tail_finL = new AdvancedModelBox(this, "tail_finL");
		...
		tail_finR = new AdvancedModelBox(this, "tail_finR");
		...
		topfintail = new AdvancedModelBox(this, "topfintail");
		...
		tailbottomend = new AdvancedModelBox(this, "tailbottomend");
		...
		tailtopend = new AdvancedModelBox(this, "tailtopend");
