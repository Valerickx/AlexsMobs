...
public class ModelSeaBear extends AdvancedEntityModel<EntitySeaBear> {
	...
	public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
		...
		animator.rotate(body, 0, Maths.rad(-10), 0);
		animator.rotate(head, 0, Maths.rad(10), 0);
		animator.rotate(tail, 0, Maths.rad(10), 0);
		animator.move(right_arm, 1, 0, -5);
		animator.rotate(right_arm, Maths.rad(-110),  Maths.rad(10), Maths.rad(-10));
		animator.endKeyframe();
		animator.startKeyframe(5);
		animator.rotate(body, 0, Maths.rad(-10), 0);
		animator.rotate(head, 0, Maths.rad(10), 0);
		...
		animator.rotate(right_arm, Maths.rad(-90),  Maths.rad(10), Maths.rad(-10));
		animator.endKeyframe();
		animator.setStaticKeyframe(5);
		animator.resetKeyframe(5);
		animator.setAnimation(EntitySeaBear.ANIMATION_ATTACK);
		animator.startKeyframe(3);
		animator.rotate(body, 0, Maths.rad(-20), 0);
		...
		animator.rotate(left_arm, Maths.rad(-110),  Maths.rad(-10), Maths.rad(10));
		animator.endKeyframe();
		animator.startKeyframe(3);
		animator.rotate(body, 0, Maths.rad(-20), 0);
		animator.rotate(head, 0, Maths.rad(20), 0);
