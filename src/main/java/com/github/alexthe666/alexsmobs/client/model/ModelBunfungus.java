...
public class ModelBunfungus extends AdvancedEntityModel<EntityBunfungus> {
    ...
    public void setupAnim(EntityBunfungus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(tail, fallProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(head, fallProgress, Maths.rad(-20), 0, 0, 5F);
        progressRotationPrev(right_arm, fallProgress, Maths.rad(-130), Maths.rad(20), 0, 5F);
        progressRotationPrev(left_arm, fallProgress, Maths.rad(-130), Maths.rad(-20), 0, 5F);
