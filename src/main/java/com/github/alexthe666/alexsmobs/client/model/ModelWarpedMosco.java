...
public class ModelWarpedMosco extends AdvancedEntityModel<EntityWarpedMosco> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(chest,0,  Maths.rad(40F), 0);
        animator.rotate(shoulder_right, Maths.rad(40F),  Maths.rad(20F), 0);
        animator.rotate(arm_right, Maths.rad(-80F), 0, 0);
        animator.rotate(hand_right, Maths.rad(-30F), 0, 0);
        animator.rotate(shoulder_left, Maths.rad(20F), 0, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(body,0,  Maths.rad(-20F), 0);
        animator.rotate(chest,0,  Maths.rad(-40F), 0);
        animator.rotate(head,0,  Maths.rad(30F), 0);
        animator.rotate(shoulder_right, Maths.rad(-20F),  Maths.rad(20F), Maths.rad(20F));
        animator.rotate(arm_right, Maths.rad(-20F), 0, 0);
        animator.rotate(hand_right, Maths.rad(-30F), Maths.rad(-30F), 0);
        animator.rotate(shoulder_left, Maths.rad(20F), 0, 0);
        animator.endKeyframe();
        ...
        animator.startKeyframe(10);
        animator.rotate(chest,0,  Maths.rad(-40F), 0);
        animator.rotate(shoulder_left, Maths.rad(40F),  Maths.rad(-20F), 0);
        animator.rotate(arm_left, Maths.rad(-80F), 0, 0);
        animator.rotate(hand_right, Maths.rad(-30F), 0, 0);
        animator.rotate(shoulder_right, Maths.rad(20F), 0, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(body,0,  Maths.rad(20F), 0);
        animator.rotate(chest,0,  Maths.rad(40F), 0);
        animator.rotate(head,0,  Maths.rad(-30F), 0);
        animator.rotate(shoulder_left, Maths.rad(-20F),  Maths.rad(-20F), Maths.rad(-20F));
        animator.rotate(arm_left, Maths.rad(-20F), 0, 0);
        animator.rotate(hand_left, Maths.rad(-30F), Maths.rad(30F), 0);
        animator.rotate(shoulder_right, Maths.rad(20F), 0, 0);
        animator.endKeyframe();
        animator.setStaticKeyframe(5);
        animator.resetKeyframe(5);
        ...
        animator.startKeyframe(10);
        animator.rotate(chest, Maths.rad(-30F), 0, 0);
        animator.rotate(shoulder_left, Maths.rad(-160F), Maths.rad(20F), Maths.rad(-10F));
        animator.rotate(shoulder_right, Maths.rad(-160F), Maths.rad(-20F), Maths.rad(10F));
        animator.rotate(arm_right, Maths.rad(-20F), 0, 0);
        animator.rotate(arm_left, Maths.rad(-20F), 0, 0);
        animator.endKeyframe();
        animator.setStaticKeyframe(5);
        animator.startKeyframe(5);
        animator.rotate(chest, Maths.rad(60F), 0, 0);
        animator.rotate(body, Maths.rad(40F), 0, 0);
        animator.rotate(head, Maths.rad(-60F), 0, 0);
        animator.rotate(legfront_left, Maths.rad(-40F), 0, 0);
        animator.rotate(legfront_right, Maths.rad(-40F), 0, 0);
        animator.rotate(legback_left, Maths.rad(-40F), 0, Maths.rad(-30F));
        animator.rotate(legback_right, Maths.rad(-40F), 0, Maths.rad(30F));
        animator.rotate(shoulder_left, Maths.rad(-100F), Maths.rad(20F), Maths.rad(-10F));
        animator.rotate(shoulder_right, Maths.rad(-100F), Maths.rad(-20F), Maths.rad(10F));
        animator.rotate(arm_right, Maths.rad(-20F), 0, 0);
        animator.rotate(arm_left, Maths.rad(-20F), 0, 0);
        ...
        animator.startKeyframe(5);
        animator.rotate(chest, Maths.rad(-25F), 0, 0);
        animator.rotate(head, Maths.rad(-25F), 0, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(chest, Maths.rad(20F), 0, 0);
        animator.rotate(head, Maths.rad(-30F), 0, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(chest, Maths.rad(-25F), 0, 0);
        animator.rotate(head, Maths.rad(-25F), 0, 0);
    ...
    public void setupAnim(EntityWarpedMosco entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(chest, walkProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(wingbottom_left, walkProgress, 0, Maths.rad(-50), 0, 5F);
        progressRotationPrev(wingbottom_right, walkProgress, 0, Maths.rad(50), 0, 5F);
        progressRotationPrev(wingtop_left, walkProgress, 0, Maths.rad(-50), 0, 5F);
        progressRotationPrev(wingtop_right, walkProgress, 0, Maths.rad(50), 0, 5F);
        progressRotationPrev(head, walkProgress, Maths.rad(-20), 0, 0, 5F);
        progressRotationPrev(back, walkProgress, Maths.rad(10), 0, 0, 5F);
        progressRotationPrev(head, flyProgress, Maths.rad(-20), 0, 0, 5F);
        progressRotationPrev(body, flyProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(legback_left, flyProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(legback_right, flyProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(legfront_left, flyProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(legfront_right, flyProgress, Maths.rad(20), 0, 0, 5F);
        progressRotationPrev(chest, flyLeftProgress, 0, Maths.rad(30), 0, 5F);
        progressRotationPrev(head, flyLeftProgress, 0, Maths.rad(-30), 0, 5F);
        progressRotationPrev(shoulder_left, flyLeftProgress, Maths.rad(-30), Maths.rad(-30), 0, 5F);
        progressRotationPrev(arm_left, flyLeftProgress, Maths.rad(-40), Maths.rad(10), 0, 5F);
        progressRotationPrev(hand_left, flyLeftProgress, Maths.rad(-30), Maths.rad(60),  Maths.rad(20), 5F);
        progressRotationPrev(chest, flyRightProgress, 0, Maths.rad(-30), 0, 5F);
        progressRotationPrev(head, flyRightProgress, 0, Maths.rad(30), 0, 5F);
        progressRotationPrev(shoulder_right, flyRightProgress, Maths.rad(-30), Maths.rad(30), 0, 5F);
        progressRotationPrev(arm_right, flyRightProgress, Maths.rad(-40), Maths.rad(-10), 0, 5F);
        progressRotationPrev(hand_right, flyRightProgress, Maths.rad(-30), Maths.rad(-60),  Maths.rad(-20), 5F);
        if (flyProgress <= 0F) {
